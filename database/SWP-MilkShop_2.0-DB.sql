DROP DATABASE IF EXISTS Milk_Shop_v2.0;
CREATE DATABASE Milk_Shop_v2.0;
USE Milk_Shop;
...
INSERT INTO FEEDBACK (ProductID, UserID, Rating, Content) VALUES
('P001', 'U001', 5, 'Excellent product! Exceeded my expectations.'),
('P001', 'U002', 4, 'Very good, but could be improved in some areas.'),
('P001', 'U003', 3, 'Average, meets the basic requirements.'),
('P001', 'U001', 2, 'Not satisfied, expected better quality.'),

('P002', 'U002', 4, 'Great value for money.'),
('P002', 'U003', 5, 'Outstanding product, highly recommend!'),
('P002', 'U001', 3, 'Good, but has some minor issues.'),
('P002', 'U002', 4, 'Pretty decent overall.'),
('P002', 'U003', 3, 'It\'s okay, but I have seen better.'),

('P003', 'U003', 2, 'Disappointed with the performance.'),
('P003', 'U001', 4, 'Very satisfied with the purchase.'),
('P003', 'U002', 5, 'Perfect! Exactly what I needed.'),
('P003', 'U003', 3, 'It\'s alright, nothing special.'),
('P003', 'U001', 4, 'Good quality, would buy again.'),

('P004', 'U002', 5, 'Fantastic product! Love it.'),
('P004', 'U003', 4, 'Works well, happy with the purchase.'),
('P004', 'U001', 3, 'Meets expectations, but room for improvement.'),
('P004', 'U002', 4, 'Very good, satisfied with it.'),
('P004', 'U003', 3, 'Average, but does the job.'),

('P005', 'U001', 2, 'Not up to the mark.'),
('P005', 'U002', 3, 'Decent product, but has flaws.'),
('P005', 'U003', 4, 'Good quality for the price.'),
('P005', 'U001', 5, 'Absolutely amazing, highly recommend!'),

('P006', 'U002', 4, 'Very good product, worth the money.'),
('P006', 'U003', 5, 'Excellent, couldn\'t be happier.'),
('P006', 'U001', 3, 'It\'s okay, not the best.'),
('P006', 'U002', 4, 'Pretty good, no major issues.'),
('P006', 'U003', 3, 'Satisfactory, does what it claims.'),

('P007', 'U001', 4, 'Great product, would recommend.'),
('P007', 'U002', 5, 'Top-notch, very pleased.'),
('P007', 'U003', 3, 'Average performance.'),
('P007', 'U001', 4, 'Good quality, worth the price.'),

('P008', 'U002', 5, 'Outstanding product, very happy with it.'),
('P008', 'U003', 4, 'Works as expected, no issues.'),
('P008', 'U001', 3, 'It\'s okay, nothing special.'),
('P008', 'U002', 4, 'Satisfied with the quality.'),
('P008', 'U003', 3, 'Average, meets basic needs.'),

('P009', 'U001', 2, 'Not very satisfied with the quality.'),
('P009', 'U002', 3, 'Decent product, could be better.'),
('P009', 'U003', 4, 'Good, but not great.'),
('P009', 'U001', 5, 'Excellent, exceeded my expectations!'),

('P010', 'U002', 4, 'Very good, happy with the purchase.'),
('P010', 'U003', 5, 'Amazing product, highly recommend.'),
('P010', 'U001', 3, 'It\'s okay, does the job.'),
('P010', 'U002', 4, 'Good quality, worth the money.'),
('P010', 'U003', 3, 'Average, nothing exceptional.');
